...
//Datos de WiFi
const char* ssid = "QWERTY2.4";  // Aquí debes poner el nombre de tu red
const char* password = "AAAM21211105qwerty@@";  // Aquí debes poner la contraseña de tu red

//Datos del broker MQTT
const char* mqtt_server = "192.168.0.104"; // Si estas en una red local, coloca la IP asignada, en caso contrario, coloca la IP publica
...
void loop() {
  ...
  if (timeNow - timeLast > wait) { // Manda un mensaje por MQTT cada cinco segundos
    ...
    String json = "{\"id\":\"Angel\",\"temp\":"+String(t)+",\"hum\":"+String(h)+"}";
    ...
    client.publish("codigoIoT/flow7/mqttin", char_array); 
